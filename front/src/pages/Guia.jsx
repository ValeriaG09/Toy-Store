...
const videoTutorials = [
  {
    ...
    color: { bg: 'from-purple-600 to-blue-600', border: 'border-purple-400', badge: 'bg-purple-500', text: 'text-purple-300' }
  },
  {
    id: 2,
    ...
    color: { bg: 'from-emerald-600 to-teal-600', border: 'border-emerald-400', badge: 'bg-emerald-500', text: 'text-emerald-300' }
  }
];
...
const toyGuides = [
  {
    ...
    color: { border: 'border-purple-400', bg: 'bg-purple-50', badge: 'bg-purple-500', icon: 'bg-purple-100' },
    level: "Principiante",
  ...
  },
  {
    ...
    color: { border: 'border-pink-400', bg: 'bg-pink-50', badge: 'bg-pink-500', icon: 'bg-pink-100' },
    level: "Intermedio",
  ...
  },
  {
    ...
    color: { border: 'border-amber-400', bg: 'bg-amber-50', badge: 'bg-amber-500', icon: 'bg-amber-100' },
    level: "Aventurero",
...
export default function Guia() {
  ...
  const [lotsoQuote, setLotsoQuote] = useState('');
  const [lotsoVisible, setLotsoVisible] = useState(false);
  const [activePill, setActivePill] = useState(null);
  const [confetti, setConfetti] = useState([]);

  const lotsoQuotes = [
    "«¡Bienvenidos a Sunnyside! Aquí todos juegan… y aprenden con estilo.» 🌸",
    "«¿Mitos? ¡Ninguno sobrevive a mi pelaje de fresa! 🍓»",
    "«El conocimiento, como yo, huele a fresas y nunca caduca.» 🐻",
    "«¡Aquí en Sunnyside, la educación es lo primero! ¡Y los abrazos también!» 💕",
    "«Yo era el juguete favorito de Daisy… ahora soy tu guía favorito.» ⭐",
  ];

  const triggerLotso = () => {
    const q = lotsoQuotes[Math.floor(Math.random() * lotsoQuotes.length)];
    setLotsoQuote(q);
    setLotsoVisible(true);
    // confetti burst
    ...
    setConfetti(pieces);
    setTimeout(() => { setLotsoVisible(false); setConfetti([]); }, 4000);
  };
  ...
  return (
    <RoomWrapper theme="lotso" showFooter={true}>
      ...
      <div className="px-4 md:px-8 lg:px-12 pt-6 pb-24 relative z-10 max-w-6xl mx-auto font-sans">
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-8">
            {movies.map((m, i) => (
              <button
                ...
                className={`px-4 py-2 rounded-full text-xs font-black uppercase tracking-wider border-2 transition-all duration-300 ${activePill === i
        ...
        <section className="mb-16">
          <div className="relative bg-gradient-to-br from-pink-600 via-fuchsia-700 to-purple-800 rounded-[3rem] p-8 md:p-12 shadow-2xl border-4 border-pink-300/60 overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
              {/* Lotso */}
              <div className="relative shrink-0 group cursor-pointer" onClick={triggerLotso}>
                <div className="absolute -inset-4 bg-pink-400/30 rounded-full blur-2xl group-hover:bg-pink-300/50 transition-all duration-500" />
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-pink-100 font-medium text-base md:text-lg leading-relaxed mb-6 max-w-lg">
                  El oso de fresa más famoso de Sunnyside te guiará por esta aventura educativa.
                  ¡Haz clic en él para escuchar su sabiduría!
                </p>

                <button
                  onClick={triggerLotso}
                ...
                >
                  ...
                  <span>¡Pregúntale a Lotso!</span>
                  <span className="bg-amber-700/30 text-[11px] px-2 py-1 rounded-full">¡Clic!</span>
                </button>

                {/* Globo de diálogo */}
                {lotsoVisible && (
                  <div className="mt-5 relative bg-white rounded-2xl px-6 py-4 shadow-xl border-4 border-pink-300 max-w-md animate-in zoom-in duration-300">
                    <div className="absolute -top-4 left-10 w-0 h-0 border-l-8 border-r-8 border-b-[16px] border-l-transparent border-r-transparent border-b-pink-300" />
                    <div className="absolute -top-3 left-10 w-0 h-0 border-l-8 border-r-8 border-b-[16px] border-l-transparent border-r-transparent border-b-white ml-[2px]" />
                    <p className="text-pink-800 font-bold text-sm md:text-base italic leading-relaxed">{lotsoQuote}</p>
                    <div className="flex items-center gap-2 mt-2">
                      <div className="w-2 h-2 rounded-full bg-pink-400 animate-pulse" />
                      <span className="text-[10px] text-pink-500 font-black uppercase tracking-wider">Lotso • Toy Story 3</span>
                    </div>
                  </div>
                )}
              </div>
        ...
        <section className="mb-16">
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-3 bg-white/20 backdrop-blur-sm px-6 py-2 rounded-full border-2 border-white/40 mb-4">
              ...
              <span className="text-xs font-black uppercase tracking-[3px] text-white">Sección 1</span>
              <span className="text-lg">✨</span>
            </div>
            ...
            <p className="text-pink-100 font-medium text-base max-w-xl mx-auto">
              Haz clic en cada tarjeta para revelar la verdad… ¡al estilo Toy Story!
            </p>
          </div>
              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    transform: flippedMyths[idx] ? 'rotateY(180deg)' : 'rotateY(0deg)'
                  }}
                >
                  {/* FRENTE */}
                  <div
                    className="absolute inset-0 rounded-[2.5rem] overflow-hidden shadow-2xl border-4 border-fuchsia-400"
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-white text-center">
                      ...
                      <div className="bg-white/20 backdrop-blur-sm px-4 py-1 rounded-full text-xs font-black uppercase tracking-wider mb-4 border border-white/30">
                        🎬 {myth.movie}
                      </div>
                  ...
                  {/* REVERSO */}
                  <div
                    className="absolute inset-0 rounded-[2.5rem] overflow-hidden shadow-2xl border-4 border-emerald-400 bg-[#f0fdf4]"
                    style={{ backfaceVisibility: 'hidden', transform: 'rotateY(180deg)' }}
                  >
                    <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center">
                      <div className="text-5xl mb-3">💡</div>
                      <div className="bg-emerald-500 text-white px-4 py-1 rounded-full text-xs font-black uppercase tracking-wider mb-4">
                        ✅ Realidad
                      </div>
                      <p className="text-emerald-900 font-bold text-base leading-relaxed mb-4">
                        {myth.reality}
                      </p>
        ...
        <section className="mb-16">
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-3 bg-white/20 backdrop-blur-sm px-6 py-2 rounded-full border-2 border-white/40 mb-4">
              <span className="text-lg">💖</span>
              <span className="text-xs font-black uppercase tracking-[3px] text-white">Sección 2</span>
              <span className="text-lg">🚀</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-black text-white uppercase mb-3"
              style={{ textShadow: '0 4px 20px rgba(0,0,0,0.5)' }}>
            ...
            <p className="text-pink-100 font-medium max-w-xl mx-auto">
              Instrucciones visuales para que todas tus misiones sean 100% seguras, cómodas y placenteras.
            </p>
          </div>
            ...
            {videoTutorials.map((video) => (
              ...
              >
                ...
                <div className={`bg-gradient-to-r ${video.color.bg} p-4 flex items-center gap-3`}>
                  ...
                  <div className="ml-auto bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-white text-[10px] font-black uppercase tracking-wider border border-white/30">
                    🎬 Tutorial
                  </div>
                </div>
                ...
                <div className="h-56 bg-slate-900 relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    ...
                    <span className="mt-3 text-white font-black uppercase tracking-widest text-sm bg-black/50 px-4 py-1.5 rounded-full backdrop-blur-sm">
                      Ver Tutorial
                    </span>
                  </div>
                </div>
                ...
                <div className="p-6">
                  ...
                  {/* Cita del personaje */}
                  <div className={`bg-gradient-to-r ${video.color.bg} bg-opacity-10 rounded-2xl p-4 border-l-4 ${video.color.border}`}>
        ...
        <section className="mb-8">
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-3 bg-white/20 backdrop-blur-sm px-6 py-2 rounded-full border-2 border-white/40 mb-4">
              <span className="text-lg">🧸</span>
              <span className="text-xs font-black uppercase tracking-[3px] text-white">Sección 3</span>
              <span className="text-lg">🎁</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-black text-white uppercase mb-3"
              style={{ textShadow: '0 4px 20px rgba(0,0,0,0.5)' }}>
            ...
            <p className="text-pink-100 font-medium max-w-xl mx-auto">
              Pasa el cursor sobre cada juguete para ver el consejo de su personaje Toy Story.
            </p>
          </div>

          {/* Banner decorativo Toy Story 3 */}
            ...
            <div className="bg-gradient-to-r from-slate-900 via-purple-900 to-pink-900 p-5 flex items-center gap-6 border-2 border-purple-500/40">
              ...
              <div className="ml-auto flex gap-2 flex-wrap">
                {['🤠 Principiante', '🚀 Intermedio', '⭐ Aventurero'].map((l, i) => (
                  <span key={i} className="text-[10px] font-black uppercase tracking-wider bg-white/10 text-white px-3 py-1 rounded-full border border-white/20 whitespace-nowrap">
                    {l}
                  </span>
                ))}
              </div>
              ...
              >
                ...
                <div className={`${guide.color.bg} p-5 border-b-4 ${guide.color.border} relative overflow-hidden`}>
                  ...
                  <div className="relative z-10 flex items-center gap-4">
                    <div className={`w-14 h-14 ${guide.color.icon} rounded-2xl flex items-center justify-center text-3xl shadow-md border-2 ${guide.color.border}`}>
                      {guide.icon}
                    </div>
                    <div>
                      <h3 className="font-black text-slate-800 text-lg uppercase tracking-tight">{guide.title}</h3>
                      <div className="flex items-center gap-1.5 mt-0.5">
                        <span className={`text-[10px] font-black uppercase tracking-wider ${guide.color.badge.replace('bg-', 'text-')} `}>
                          🎭 {guide.character}
                        </span>
                ...
                <div className="p-6">
                  ...
                  <div className={`relative ${guide.color.bg} rounded-2xl p-5 border-2 ${guide.color.border}`}>
                    {/* Burbuja superior */}
                    <div className={`absolute -top-5 left-6 ${guide.color.badge} text-white text-xl w-10 h-10 rounded-full flex items-center justify-center border-4 border-white shadow-md`}>
                      💡
                    </div>
                    <p className={`text-[10px] ${guide.color.badge.replace('bg-', 'text-')} font-black uppercase tracking-widest text-center mt-3 mb-2`}>
                      Consejo de {guide.character}:
                    </p>
                    <p className="text-sm text-slate-700 font-medium text-center italic leading-relaxed">
                      "{guide.tip}"
                    </p>
                  </div>
                </div>
                ...
                <div className={`px-6 pb-6 transition-all duration-300 ${hoveredToy === guide.id ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                  <button
                    ...
                    className={`w-full py-3 bg-gradient-to-r ${guide.id === 1 ? 'from-purple-500 to-purple-600' : guide.id === 2 ? 'from-pink-500 to-pink-600' : 'from-amber-500 to-amber-600'} text-white font-black text-sm uppercase tracking-wider rounded-xl shadow-lg hover:scale-105 active:scale-95 transition-transform flex items-center justify-center gap-2`}
                  >
                    <span>🛒</span>
                    <span>Ver en el Baúl</span>
                  </button>
                </div>
              </div>
            ))}
        ...
        <section className="text-center">
          <div className="relative bg-gradient-to-br from-slate-900 via-purple-900 to-pink-900 rounded-[3rem] p-10 md:p-16 shadow-2xl border-4 border-purple-400/60 overflow-hidden">
            ...
            <div className="absolute -top-16 -left-16 w-56 h-56 bg-pink-500/20 rounded-full blur-3xl" />
            <div className="absolute -bottom-16 -right-16 w-56 h-56 bg-purple-500/20 rounded-full blur-3xl" />
            ...
            <div className="relative z-10">
              ...
              <p className="text-purple-200 font-medium text-base md:text-lg max-w-xl mx-auto mb-8 leading-relaxed">
                El baúl de Andy está repleto de juguetes esperando ser descubiertos.
                ¡Empieza tu misión ahora!
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button
                  onClick={() => navigate('/tienda')}
                  className="px-10 py-4 bg-gradient-to-r from-yellow-400 to-amber-500 hover:from-yellow-300 hover:to-amber-400 text-slate-900 font-black text-base uppercase tracking-wider rounded-2xl shadow-2xl hover:shadow-yellow-400/30 hover:scale-105 active:scale-95 transition-all border-4 border-yellow-200 flex items-center justify-center gap-3"
                >
                ...
                <button
                  onClick={() => navigate('/')}
                  className="px-8 py-4 bg-white/10 hover:bg-white/20 text-white font-black text-sm uppercase tracking-wider rounded-2xl shadow-lg hover:scale-105 active:scale-95 transition-all border-2 border-white/30 backdrop-blur-sm flex items-center justify-center gap-2"
                >
                  <span>🏠</span>
      ...
      {activeVideo && (
        <div
          className="fixed inset-0 z-[300] bg-black/90 flex items-center justify-center p-4 backdrop-blur-md animate-in fade-in duration-300"
          onClick={() => setActiveVideo(null)}
        >
          <div
            className={`bg-white rounded-[2.5rem] w-full max-w-5xl relative shadow-[0_0_100px_rgba(0,0,0,0.5)] border-4 ${activeVideo.color.border} animate-in zoom-in-95 duration-300 overflow-hidden`}
          ...
          >
            ...
            <div className={`bg-gradient-to-r ${activeVideo.color.bg} p-5 flex items-center gap-4`}>
              ...
              <button
                onClick={() => setActiveVideo(null)}
                className="ml-auto w-12 h-12 bg-white/20 hover:bg-white/40 rounded-full flex items-center justify-center text-white font-black text-xl transition-all hover:scale-110 border-2 border-white/30"
              >
                ✕
              </button>
            </div>
