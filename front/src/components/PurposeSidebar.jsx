...
const PurposeSidebar = ({ isOpen, onClose }) => {
    ...
    return (
        <>
            ...
            <div className="absolute top-0 right-0 h-auto min-h-screen w-full lg:w-[85%] max-w-[1100px] z-[12000] flex animate-plush-bounce">

                <div className="min-h-screen h-auto w-full bg-[#E3F2FD] border-l-[12px] border-white shadow-[-30px_0_70px_rgba(33,150,243,0.15)] flex flex-col relative overflow-hidden rounded-l-[120px]">
                    ...
                    <div className="flex-1 p-8 md:p-12 lg:p-16 flex flex-col md:flex-row gap-12 lg:gap-20 items-stretch bg-[#f4fafe] z-10 w-full h-auto">
                        ...
                        <section className="flex-1 flex flex-col rounded-[60px] animate-in slide-in-from-bottom-4 duration-700">
                            ...
                            <div className="relative flex-1 mt-6">
                                ...
                                <div className="relative z-10 h-full bg-white p-10 lg:p-12 xl:p-14 rounded-[50px] border-8 border-[#E3F2FD] shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all flex flex-col justify-center">
                                    <p className="text-slate-700 font-medium leading-relaxed text-base lg:text-lg xl:text-xl text-justify mb-6">
                                    ...
                                    <p className="text-slate-600 font-normal leading-relaxed text-base lg:text-lg xl:text-xl text-justify italic">
                        ...
                        <section className="flex-1 flex flex-col pt-12 md:pt-0 animate-in slide-in-from-bottom-8 duration-700 delay-100">
                            ...
                            <div className="relative flex-1 mt-6">
                                ...
                                <div className="relative z-10 h-full bg-white p-10 lg:p-12 xl:p-14 rounded-[50px] border-8 border-[#FFF9C4] shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all flex flex-col justify-center">
                                    ...
                                    <p className="text-slate-600 font-normal leading-relaxed text-base lg:text-lg xl:text-xl text-justify">
